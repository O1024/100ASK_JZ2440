...
int main(void) {
    ...
    hal_uart_puts("Source Addr  : ");
    print_hex32(SRC_ADDR);
    hal_uart_puts("\r\n");
    hal_uart_puts("Dest Addr    : ");
    print_hex32(DST_ADDR);
    hal_uart_puts("\r\n");
    ...
    if (err)
        hal_uart_puts("RESULT: CPU Copy FAILED!\r\n");
    else
        hal_uart_puts("RESULT: CPU Copy PASSED.\r\n");
    ...
    if (err)
        hal_uart_puts("RESULT: DMA Copy FAILED!\r\n");
    else
        hal_uart_puts("RESULT: DMA Copy PASSED.\r\n");
